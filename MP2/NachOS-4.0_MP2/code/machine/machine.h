...
//
const int NumPhysPages = 128; // Number of physical frames available

const int MemorySize = (NumPhysPages * PageSize); // Size of physical memory
